...
/**
 * This program reads a users input to determine how
 * to convert a specific message using methods.
 *
 * Activity 3
...
/**
 *
 * Scans for user's message and number input
 * to determine how to convert and display
 * the user's message.
 *
